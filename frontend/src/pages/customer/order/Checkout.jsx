...
export default function Checkout() {
  ...
  return (
    <div className="co-container">
      ...
      {/* FOOTER BARU (Disamakan dengan MenuList & MenuDetail) */}
      <footer className="co-footer">
        <div className="co-socials">
          <a href="https://www.instagram.com/laoban.nusantara/" target="_blank" rel="noopener noreferrer" className="co-soc-circle">
            <img src={IconInstagram} alt="Instagram" />
          </a>
          <a href="https://api.whatsapp.com/send/?phone=%2B6282244503221&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="co-soc-circle">
            <img src={IconWhatsapp} alt="Whatsapp" />
          </a>
          <a href="https://www.facebook.com/laoban.nusantara/" target="_blank" rel="noopener noreferrer" className="co-soc-circle">
            <img src={IconFacebook} alt="Facebook" />
          </a>
          <div className="co-soc-circle">
            <img src={IconLink} alt="Link" />
          </div>
          <a href="https://www.tiktok.com/@laoban.nusantara" target="_blank" rel="noopener noreferrer" className="co-soc-circle">
